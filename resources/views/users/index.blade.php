...
@section('content')
	<section class="content-header">
		...
		<h1 class="pull-right">
			...
			<button type="button" class="btn btn-info btn-sm" data-toggle="modal" data-target="#myModal">Xuất Excel
			</button>
		</h1>
	</section>
	<div class="content">
			...
			<div class="modal-dialog">
				...
				<div class="modal-content">
					...
					<div class="modal-body">
						<select id="countries" class="multiselect" multiple="multiple" name="colums[]"
								title="chọn colum">
					...
					<div class="modal-footer">
						<button type="submit" class="btn btn-success"><i class="glyphicon glyphicon-export"></i>Tải
							xuống
						</button>
...
@section('scripts')
	...
	<script type="text/javascript"
			src="{{asset('/')}}themes/plugins/multiselect/plugins/localisation/jquery.localisation-min.js"></script>
	<script type="text/javascript" src="{{asset('/')}}themes/plugins/multiselect/ui.multiselect.js"></script>

	<script type="text/javascript">
		$(function () {
			$.localise('ui-multiselect', {language: 'en', path: '{{asset('/')}}themes/plugins/multiselect/locale/'});
